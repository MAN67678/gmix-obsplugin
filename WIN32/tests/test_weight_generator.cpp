// Unit tests for the weight helpers + BlendConfig — pure math, no GPU
// required. Portable, kept in sync with linux-x86_64/tests/test_weight_generator.cpp.
// Run: test_weight_generator.exe
