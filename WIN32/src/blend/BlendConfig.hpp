// ─────────────────────────────────────────────────────────────────────────────
// GMix (Windows) — blend configuration: the blend is a FLAT average of the
// real frames in the 1/60s window, or an optional raw power-user weight
// curve. Plus the output dimensions / pacing. The CLI populates this;
// everything else consumes it.
//
// Pure math/config, no platform dependency -- kept in sync verbatim with
// linux-x86_64/src/blend/BlendConfig.hpp.
// ─────────────────────────────────────────────────────────────────────────────
#pragma once
